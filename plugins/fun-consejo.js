...
var handler = async (m, { conn, text }) => {
  conn.reply(m.chat, `🤖🎪 *FNaF LATAM Bot* 🎪🤖\n\n⏳ Buscando un consejo para sobrevivir la noche... espera un momento...`, m);

  conn.reply(m.chat, `*┏━━━━━━━━━━━━━━━┓*\n\n🔮 *Aquí tienes un consejo que podría salvar tu próxima ronda:* 🔮\n\n*»* _${pickRandom(global.consejo)}_\n\n*┗━━━━━━━━━━━━━━━┛*\n\n👻 *Sigue atento, los animatrónicos nunca duermen...* 👻`, m);
}
...
global.consejo = [
  ...
  "Si de veras deseas ver al Creador, conviértete en un creador (Deepak Chopra)",
  ...
  "Prometa, prometa hasta que lo meta, y luego olvide lo prometido. (Viejito IA) 
