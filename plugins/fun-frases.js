...
var handler = async (m, { conn, text}) => {
  ...
  // Mensaje de espera con toque FNaF LATAM
  conn.reply(m.chat, `🕯️ *Buscando la frase oculta en las sombras...* 🕯️`, m)

  // Mensaje principal con borde tipo "glitch" y estilo oscuro
  conn.reply(m.chat, 
`*┏━━━༺👁️༻━━━┓*
  
  🕷️ *"${pickRandom(global.frases)}"*
...
// Frases con tono oscuro, misterioso y mensajes FNaF LATAM
global.frases = [
  "En la oscuridad, solo el valiente encuentra la verdad. — FNaF LATAM",
  "Nunca apagues la luz, pues ahí acechan los susurros. — Fazbear Night",
  "La noche es eterna para quienes caminan entre sombras.",
  "No todos los secretos se cuentan, algunos se susurran en la oscuridad.",
  "Caminas entre animatrónicos, pero ¿quién vigila tu alma?",
